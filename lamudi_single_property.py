...
def extract_description(soup):
    description_div = soup.find('div', {'class': 'listing-description ViewMore js-ViewMoreSection initialized'})
    description_text = description_div.find('div', {'class': 'ViewMore-text-description'}) if description_div else None
